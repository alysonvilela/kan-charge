...
export const ChargedTable = () => {
  const { response, page } = useTableViewModel();
  ...
  return (
    <div className="relative h-max overflow-auto">
            ...
            <tr key={id}>
              ...
              <td className="pr-6 py-4 whitespace-nowrap">
                {new Intl.NumberFormat("pt-BR", {
                  style: "currency",
                  currency: "BRL",
                }).format(debtAmount / 100)}
              </td>

              <td className="pr-6 py-4 whitespace-nowrap">
                <span
                  className={`px-3 py-2 rounded-full font-semibold text-xs ${"Active" == "Active" ? "text-green-600 bg-green-50" : "text-blue-600 bg-blue-50"}`}
                >
                  Ativo
                </span>
              </td>
      ...
      <Pagination
        ...
        canNext={page.CAN_NEXT}
        canPrev={page.CAN_PREV}
